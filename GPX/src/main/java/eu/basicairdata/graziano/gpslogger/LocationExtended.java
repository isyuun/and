...
public class LocationExtended {
     ...
     * @param context
     */
    public LocationExtended(Context context, Location location) {
        this.context = context;
        this.location = location;
        EGM96 egm96 = EGM96.getInstance(this.context);
        if (egm96 != null) {
    ...
    public double getAltitude() {
        return location.hasAltitude() ? location.getAltitude() : NOT_AVAILABLE;
    }

    public float getSpeed() {
        return location.hasSpeed() ? location.getSpeed() : NOT_AVAILABLE;
    }

    public float getAccuracy() {
        return location.hasAccuracy() ? location.getAccuracy() : NOT_AVAILABLE;
    }

    public float getBearing() {
        return location.hasBearing() ? location.getBearing() : NOT_AVAILABLE;
    }
