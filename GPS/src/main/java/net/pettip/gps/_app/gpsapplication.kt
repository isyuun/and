...
import net.pettip.app.Application
import net.pettip.gps.app.ForegroundOnlyLocationService
import net.pettip.gps.app.ForegroundOnlyLocationService.LocalBinder
...
open class gpsapplication : Application(), SharedPreferences.OnSharedPreferenceChangeListener, ServiceConnection {
     ...
     * IY: Deprecated
     *
     * @see : net.pettip.gps.ForegroundOnlyBroadcastReceiver2
     */
    //@Deprecated("Use net.pettip.gps.ForegroundOnlyBroadcastReceiver2 instead. ", ReplaceWith("net.pettip.gps.ForegroundOnlyBroadcastReceiver2"))
