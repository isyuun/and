...
open class ForegroundOnlyLocationService : Service() {
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        //Log.wtf(__CLASSNAME__, "${getMethodName()}:${intent}")     //Log.d(TAG, "onStartCommand()")
    ...
    override fun onUnbind(intent: Intent): Boolean {
        ...
        Log.wtf(__CLASSNAME__, "${getMethodName()}:${(!configurationChange && SharedPreferenceUtil.getLocationTrackingPref(this))}")
    ...
    private fun generateNotification(location: Location?): Notification {
        Log.wtf(__CLASSNAME__, "${getMethodName()}:${serviceRunningInForeground}::${location}")      //Log.d(TAG, "generateNotification()")
